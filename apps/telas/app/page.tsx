...
// consumidor final. Foco: dono do celular que quebrou o vidro e quer
// manter o display original. CTA primário = WhatsApp (sem formulário CNPJ).
// O funil de lojista (B2B industrial) vive em /lojista.
// ============================================================
      ...
      <div className="container">
        <div className="flex items-center justify-between py-4 gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link
              href="/lojista"
              className="inline-flex items-center gap-1 text-sm font-medium text-gray-300 hover:text-circuit-green transition-colors whitespace-nowrap"
            >
              Sou lojista <span aria-hidden>→</span>
            </Link>
            <TrackedWhatsAppLink
              phone={WHATSAPP_PHONE}
      ...
      <div className="container">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav aria-label="Links" className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm">
            <Link href="/lojista" className="text-gray-400 hover:text-circuit-green transition-colors">Sou lojista / CNPJ</Link>
